...
export function userFromPgWithState(pg: UserPg): User {
  return userFromPg(pg).setPgState(userToPg);
}

export function userFromPlain(plainData: UserPlain): User {
  const plain: UserPlain = {
    id: plainData.id,
...
export function userToPg(domain: User): UserPg {
  return {
    id: domain.id,
...
export function userToPlain(domain: User): UserPlain {
  return {
    id: domain.id,
...
export function userToJson(domain: User): UserJson {
  return {
    id: domain.id,
...
export function userToResponse(domain: User): UserResponse {
  return {
    id: domain.id,
...
export function userPgToResponse(pg: UserPg): UserResponse {
  return {
    id: pg.id,
